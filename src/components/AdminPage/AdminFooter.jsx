...
export const AdminFooter = () => {
  ...
  const restaurantFooter = [
    {
      name: "Restaurant",
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-shop-window" viewBox="0 0 16 16">
    ...
    {
      name: "Manage",
      icon: <Menu width={30} height={30} />
    },
    {
      name: "Orders",
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-receipt" viewBox="0 0 16 16">
