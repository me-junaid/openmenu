  ...
  return (
    <div className={`${openCart ? "top-[50px] fixed inset-0 bg-black flex flex-col " : "hidden"}`}>
      <div className="flex items-center p-3 pt-8 gap-2">
        ...
        <button className="ml-auto p-2 active:bg-green-200/9 active:border-yellow-200 duration-200 bg-red-900/40 text-white/87 border-green-200 border text-lg font-bold rounded-2xl flex items-center justify-between" onClick={() => updateOpenCart()}>
