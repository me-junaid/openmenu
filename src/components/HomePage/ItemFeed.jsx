      ...
      <div className='p-2 mt-0 space-y-2 mb-[100px] rounded-2xl'>
        {itemsInMenus.map((item, index) => (
          <div key={index} className='bg-[#051302] py-2 pl-5 pr-3 rounded-2xl flex'>
            ...
            <div className="h-5 min-w-5  self-center ml-3 rounded-full border border-green-200 flex justify-center items-center text-green-300"><Plus height={20} width={20}/></div>
          </div>
        ))
        }
      </div>
