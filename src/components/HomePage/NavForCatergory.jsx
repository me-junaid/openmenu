...
export const NavForCatergory = () => {
  ...
  const handleSelect = useCallback((index) => {
    ...
    const el = document.getElementsByClassName(`cat-item-${index}`);
    el.foreach?.scrollIntoView({ behavior: "smooth", inline: "center", block: "nearest" });
  }, []);
      ...
      {items.map((item, index) => {
        ...
        return (
          <div
            ...
            className={`${baseClasses} ${selectedClasses} cat-item-${index}`}
          >
